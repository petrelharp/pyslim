...
recipe_specs = {
    ...
    "recipe_long_nucleotides.slim": {
        "WF": True,
        "nucleotides": True,
        "long": True,
    },
    "recipe_mutation_spectrum.slim": {
        "WF": True,
        "nucleotides": True,
    ...
    "recipe_resettable_nonWF.slim": {
        "nonWF": True,
        "resettable": True,
        "user_metadata": True,
    },
    "recipe_retain_everyone_WF_late.slim": {
        "WF": True,
        "pedigree": True,
        "retained": True,
    },
    "recipe_retain_sometimes_WF_late.slim": {
        "WF": True,
        "pedigree": True,
        "retained": True,
    },
    "recipe_retain_unary_WF_late.slim": {
        "WF": True,
        "pedigree": True,
        "retained": True,
        "retainCoalescentOnly": False,
    },
    "recipe_retain_everyone_nonWF_late.slim": {
        "nonWF": True,
        "pedigree": True,
        "retained": True,
    },
    "recipe_retain_sometimes_nonWF_late.slim": {
        "nonWF": True,
        "pedigree": True,
        "retained": True,
    },
    "recipe_retain_unary_nonWF_late.slim": {
        "nonWF": True,
        "pedigree": True,
        "retained": True,
        "retainCoalescentOnly": False,
    },
    "recipe_remember_and_retain.slim": {
        "nonWF": True,
        "pedigree": True,
        "retained": True,
    },
    "recipe_all_the_chromosome_types.slim": {
        "nonWF": True,
        "pedigree": True,
        "multichrom": True,
        "nucleotides": True,
